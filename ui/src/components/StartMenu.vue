    ...
    <div class="w-full pr-2 flex justify-start items-center">
      ...
      <div
        class="
          ...
          flex-grow
          border
          hover:border-blue-800 hover:bg-gray-200
        "
      >
        <input
          class="pl-1 flex-grow bg-gray-100 outline-none hover:bg-gray-200"
          placeholder="搜索 ctrl+s"
        />
        <SearchIcon class="pr-1 h-4 cursor-pointer text-gray-500" />
      </div>
